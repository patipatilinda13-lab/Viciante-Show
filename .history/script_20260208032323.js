...
// Login Admin Sala
const senhaAdminSala = document.getElementById("senhaAdminSala");
const entrarAdminSala = document.getElementById("entrarAdminSala");
const loginAdminSala = document.getElementById("loginAdminSala");
...
function entrarNaSala(idSala) {
  ...
  salaAtual = sala;
  adminSalaLogado = false; // Reset admin ao entrar na sala
...
function renderizarGerenciamento() {
  ...
  if (!adminSalaLogado) {
    loginAdminSala.style.display = "block";
    containerParticipantes.style.display = "none";
    avisoPagamento.style.display = "none";
    iniciarSorteio.style.display = "none";
  } else {
    loginAdminSala.style.display = "none";
